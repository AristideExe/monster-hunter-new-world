...
procedure choixItemChambre();
//var
//  choix : string;
//begin
//  choix := choixItemChambreIHM();
//  if choix = '0' then chambre()
//  else if (choix = '1') then malle()
//  else if (choix = '2') or (choix = '3') or (choix = '4') or (choix = '5') or (choix = '6') then armoire(choix)
//  else choixItemChambre();
//end;

// Procédure de l'affichage de la chambre
procedure chambre();
begin

  //// Si on a choisit les armes
  //if choix = '1' then malle()
